...
var k = {
  ...
  A = (function () {
    function t() {
      v(this, t), g(this, 'timeline', []), g(this, 'pointer', -1);
    }
    return (
      b(t, [
        {
              ...
              if (this.timeline.length && this.pointer >= 0) {
                ...
                if (new Date().getTime() - a < n)
                  return void (this.timeline[this.pointer] = {
                    timestamp: a,
                    patches: [].concat(T(o), T(e)),
                    inversePatches: [].concat(T(t), T(i)),
                  });
              }
              this.add(e, t);
            }
            ...
            if (0 !== e.length || 0 !== t.length)
              if (this.timeline.length && this.pointer >= 0) {
                ...
                this.timeline[this.pointer] = {
                  ...
                  patches: [].concat(T(n.patches), T(e)),
                  inversePatches: [].concat(T(t), T(r)),
                };
              } else this.add(e, t);
          },
        },
...
var j,
  ...
  M = (function () {
    function e(t, n) {
      ...
      v(this, e),
        g(this, 'collected', void 0),
        g(this, 'collector', void 0),
        g(this, 'onChange', void 0),
        g(this, 'id', void 0),
        (this.collector = t),
        (this.onChange = n),
        r && this.collect();
  ...
  U = (function () {
    function e() {
      v(this, e),
        g(this, 'isEnabled', !0),
        g(this, 'elementIdMap', new WeakMap()),
        g(this, 'registry', new Map());
    }
    return (
      b(e, [
        {
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            if (r) {
              if (f.default(t.required, r.required)) return r;
...
(exports.EventHandlerUpdates = void 0),
  ((j = exports.EventHandlerUpdates || (exports.EventHandlerUpdates = {}))[
    (j.HandlerDisabled = 0)
  ] = 'HandlerDisabled'),
  (j[(j.HandlerEnabled = 1)] = 'HandlerEnabled');
var V = (function () {
    function e(t) {
      v(this, e),
        g(this, 'options', void 0),
        g(this, 'registry', new U()),
        g(this, 'subscribers', new Set()),
        (this.options = t);
    }
    return (
      b(e, [
  ...
  q = (function (e) {
    ...
    function o(e, t) {
      ...
      return (
        v(this, o),
        g(R((n = r.call(this, t))), 'derived', void 0),
        g(R(n), 'unsubscribeParentHandlerListener', void 0),
        (n.derived = e),
        (n.options = t),
    ...
    return (
      b(o, [
        ...
        },
        {
          key: 'cleanup',
          value: function () {
            _(m(o.prototype), 'cleanup', this).call(this),
...
(exports.DEPRECATED_ROOT_NODE = 'canvas-ROOT'),
  (exports.DerivedEventHandlers = q),
  ...
  (exports.EventHandlers = V),
  (exports.HISTORY_ACTIONS = k),
  (exports.History = A),
  (exports.ROOT_NODE = 'ROOT'),
  (exports.RenderIndicator = ({ style: e, className: t, parentDom: n }) => {
    const r = l.default.createElement('div', {
      className: t,
      style: {
        position: 'fixed',
        display: 'block',
    ...
    return n && n.ownerDocument !== document
      ? p.default.createPortal(r, n.ownerDocument.body)
      : r;
  }),
  (exports.cloneWithRef = B),
  (exports.createQuery = S),
              ...
              d = w(
                e.produceWithPatches(i, function (e) {
                  ...
                  switch (u.type) {
                    ...
                    case k.THROTTLE:
                      var r,
                        o = x((n = u.payload)) || N(n) || I(n) || C(),
                        i = o[0],
                        c = o.slice(1);
                      (r = a(e, f))[i].apply(r, T(c));
                      break;
                    default:
                      (t = a(e, f))[u.type].apply(t, T(u.payload));
                  }
                }),
                3
              ),
            ...
            return (
              ...
              r &&
                r(
                  p,
                  i,
                  { type: u.type, params: u.payload, patches: h },
                  f,
                  function (t) {
              ...
              [k.UNDO, k.REDO].includes(u.type) && t && (l = c.default(l, t)),
              []
                .concat(T(n), [k.UNDO, k.REDO, k.IGNORE, k.CLEAR])
                .includes(u.type) ||
                (u.type === k.THROTTLE
                  ? s.throttleAdd(h, v, u.config && u.config.rate)
                  : u.type === k.MERGE
                  ? s.merge(h, v)
                  : s.add(h, v)),
              l
        ...
        function () {
          ...
          return y(
            ...
            {},
            {
              history: {
                undo: function () {
                  return E({ type: k.UNDO });
                },
                redo: function () {
                  return E({ type: k.REDO });
                },
                clear: function () {
                  return E({ type: k.CLEAR });
                },
                throttle: function (n) {
                  return y(
                    {},
                        ...
                        return (
                          (e[t] = function () {
                            for (
                              ...
                              n[r] = arguments[r];
                            return E({ type: k.MERGE, payload: [t].concat(n) });
                          }),
                          e
                        );
                      }, {})
  ...
  (exports.wrapHookToRecognizeElement = F);
