...
function O(n) {
  const r = y(),
    o = t.useContext(m);
  l.default(o, e.ERROR_USE_EDITOR_OUTSIDE_OF_EDITOR_CONTEXT);
  const s = e.useCollector(o, n),
    d = t.useMemo(() => r && r.createConnectorsUsage(), [r]);
  t.useEffect(
    () => (
      d.register(),
      () => {
  ...
  return E(E({}, s), {}, { connectors: a, inContext: !!o, store: o });
}
const R = ['actions', 'query', 'connectors'];
function T(n) {
  const r = t.useContext(p);
  l.default(r, e.ERROR_USE_NODE_OUTSIDE_OF_EDITOR_CONTEXT);
  const { id: o, related: s } = r,
    d = O((e) => o && e.nodes[o] && n && n(e.nodes[o])),
    { actions: a, connectors: i } = d,
    c = v(d, R),
    u = t.useMemo(
      () =>
        e.wrapConnectorHooks({
          connect: (e) => i.connect(e, o),
          drag: (e) => i.drag(e, o),
        }),
      [i, o]
    ),
  ...
  return E(
    E({}, c),
    {},
    { id: o, related: s, inNodeContext: !!r, actions: h, connectors: u }
  );
}
const b = ['id', 'related', 'actions', 'inNodeContext', 'connectors'];
function _(t) {
  const n = T(t),
    { id: r, related: o, actions: s, inNodeContext: d, connectors: a } = n;
  return E(
    E({}, v(n, b)),
    {},
    {
...
const D = ({ render: e }) => {
  ...
  C = () => {
    const { type: e, props: n, nodes: r, hydrationTimestamp: o } = T((e) => ({
      type: e.data.type,
      props: e.data.props,
      nodes: e.data.nodes,
    ...
    return t.useMemo(() => {
      ...
      r &&
        ...
        (t = a.default.createElement(
          a.default.Fragment,
          null,
          r.map((e) => a.default.createElement(I, { id: e, key: e }))
        ));
      const o = a.default.createElement(e, n, t);
      return 'string' == typeof e
        ? a.default.createElement(D, { render: o })
        : o;
    }, [e, n, o, r]);
  },
  x = ({ render: e }) => {
    const { hidden: t } = T((e) => ({ hidden: e.data.hidden })),
  ...
  S = { is: 'div', canvas: !1, custom: {}, hidden: !1 },
  w = { is: 'type', canvas: 'isCanvas' };
function k({ id: n, children: r, ...o }) {
  const { is: s } = { ...S, ...o },
    { query: d, actions: i } = O(),
    { id: c, inNodeContext: u } = T(),
    [p] = t.useState(() => {
...
const P = () => {
  ...
  return t ? a.default.createElement(I, { id: e.ROOT_NODE, key: t }) : null;
};
var j;
...
function M(e) {
  const { connectors: n, actions: r, query: o, store: s, ...d } = O(e),
    a = A(r);
  return {
    connectors: n,
    actions: t.useMemo(
      () => ({
        ...
        history: {
          ...a.history,
          ignore: (...e) => A(a.history.ignore(...e)),
          throttle: (...e) => A(a.history.throttle(...e)),
        },
      }),
      [a]
    ),
  ...
  H = (t, n) => {
    const r = (n, r, s) => {
        const d = (r, o) => {
          ...
          'string' != typeof s.data.type &&
            ...
            (t.nodes[r] = E(
              E({}, s),
              {},
              { data: E(E({}, s.data), {}, { parent: o }) }
            )),
            s.data.nodes.length > 0 &&
              (delete t.nodes[r].data.props.children,
              s.data.nodes.forEach((e) => d(e, s.id))),
            Object.values(s.data.linkedNodes).forEach((e) => d(e, s.id));
        };
        if ((d(n.rootNodeId, r), !r && n.rootNodeId === e.ROOT_NODE)) return;
        const a = o(r);
        if ('child' === s.type) {
          const e = s.index;
          return void (null != e
      ...
      o = (n) => {
        ...
        const r = t.nodes[n];
        return l.default(r, e.ERROR_INVALID_NODEID), r;
      },
      s = (e) => {
        const n = t.nodes[e],
          r = t.nodes[n.data.parent];
        if (
          (n.data.nodes && [...n.data.nodes].forEach((e) => s(e)),
          n.data.linkedNodes &&
            Object.values(n.data.linkedNodes).map((e) => s(e)),
          r.data.nodes.includes(e))
        ) {
          const t = r.data.nodes;
    ...
    return {
      addLinkedNodeFromTree(e, t, n) {
        const d = o(t).data.linkedNodes[n];
        d && s(d), r(e, t, { type: 'linked', id: n });
      },
      add(t, n, o) {
        let s = [t];
        Array.isArray(t) &&
          ...
          (s = t)),
          s.forEach((e) => {
            r({ nodes: { [e.id]: e }, rootNodeId: e.id }, n, {
              type: 'child',
              index: o,
            });
          });
      ...
      delete(r) {
        F(t.nodes, r, { existOnly: !0, idOnly: !0 }).forEach((t) => {
          let { node: r } = t;
          l.default(
      ...
      deserialize(t) {
        const r = 'string' == typeof t ? JSON.parse(t) : t,
          o = Object.keys(r).map((t) => {
            let o = t;
            return (
              t === e.DEPRECATED_ROOT_NODE && (o = e.ROOT_NODE),
              [o, n.parseSerializedNode(r[t]).toNode((e) => (e.id = o))]
            );
          });
        this.replaceNodes(q(o));
      },
      move(e, r, o) {
        const s = F(t.nodes, e, { existOnly: !0 }),
          d = t.nodes[r],
          a = new Set();
        s.forEach((e, s) => {
          let { node: i } = e;
          ...
          const p = u.indexOf(l);
          (u[p] = '$$'),
            d.data.nodes.splice(o + s, 0, l),
            (t.nodes[l].data.parent = r);
        }),
          a.forEach((e) => {
            const t = e.length;
      ...
      setNodeEvent(e, n) {
        if (
          ...
          return;
        const r = F(t.nodes, n, { idOnly: !0, existOnly: !0 }),
          o = new Set(
            r.map((e) => {
              let { node: t } = e;
              return t.id;
      ...
      setCustom(e, n) {
        F(t.nodes, e, { idOnly: !0, existOnly: !0 }).forEach((e) => {
          let { node: r } = e;
          return n(t.nodes[r.id].data.custom);
        });
      },
      setDOM(e, n) {
      ...
      setProp(e, n) {
        F(t.nodes, e, { idOnly: !0, existOnly: !0 }).forEach((e) => {
          let { node: r } = e;
          return n(t.nodes[r.id].data.props);
        });
      },
      selectNode(e) {
        if (e) {
          const n = F(t.nodes, e, { idOnly: !0, existOnly: !0 });
          this.setNodeEvent(
            'selected',
            n.map((e) => {
              let { node: t } = e;
...
const W = (t, n) => {
    ...
    return (
      l.default(
        ...
        e.ERROR_NOT_IN_RESOLVER.replace(
          '%node_type%',
          (o = n).name || o.displayName
        )
      ),
      r
    );
  },
  B = (e, t) => ('string' == typeof e ? e : { resolvedName: W(t, e) }),
  $ = (e, n) => {
    let { type: r, isCanvas: o, props: s } = e;
    return (
      (s = Object.keys(s).reduce((e, r) => {
        const o = s[r];
        return (
          null == o ||
            'function' == typeof o ||
            (e[r] =
              'children' === r && 'string' != typeof o
                ? t.Children.map(o, (e) => ('string' == typeof e ? e : $(e, n)))
      ...
      { type: B(r, n), isCanvas: !!o, props: s }
    );
  },
  U = (e, t) => {
    const { type: n, props: r, isCanvas: o, name: s, ...d } = e;
    return { ...$({ type: n, isCanvas: o, props: r }, t), ...d };
  };
function J(t, n) {
  ...
  const r = t.nodes[n],
    o = (e) => J(t, e);
  return {
    isCanvas: () => !!r.data.isCanvas,
    isRoot: () => r.id === e.ROOT_NODE,
    isLinkedNode: () =>
      r.data.parent && o(r.data.parent).linkedNodes().includes(r.id),
    isTopLevelNode() {
    ...
    isParentOfTopLevelNodes: () =>
      r.data.linkedNodes && Object.keys(r.data.linkedNodes).length > 0,
    ...
    ancestors() {
      ...
      return (function n(r) {
        ...
        return d
          ? (o.push(r),
            d.data.parent
              ? ((e || (!e && 0 === s)) && (o = n(d.data.parent, o, s + 1)), o)
              : o)
          : o;
      })(r.data.parent);
    },
    ...
    linkedNodes: () => Object.values(r.data.linkedNodes || {}),
    childNodes: () => r.data.nodes || [],
    isDraggable(n) {
      try {
        const n = r;
        return (
          ...
          l.default(
            J(t, n.data.parent).isCanvas(),
            e.ERROR_MOVE_NONCANVAS_CHILD
          ),
          l.default(n.rules.canDrag(n, o), e.ERROR_CANNOT_DRAG),
          !0
        );
      } catch (e) {
        return n && n(e), !1;
    ...
    isDroppable(n, s) {
      ...
      try {
        ...
        return (
          d.forEach((r) => {
            let { node: s, exists: d } = r;
            if (
              (l.default(s.rules.canDrop(a, s, o), e.ERROR_MOVE_CANNOT_DROP),
              !d)
            )
              return;
            l.default(!o(s.id).isTopLevelNode(), e.ERROR_MOVE_TOP_LEVEL_NODE);
            const i = o(s.id).descendants(!0);
            l.default(
    ...
    toSerializedNode: () => U(r.data, t.options.resolver),
    toNodeTree(e) {
...
function Y(t, n) {
  ...
  if (o.data.type === k || o.data.type === Canvas) {
    const e = E(E({}, S), o.data.props);
    (o.data.props = Object.keys(o.data.props).reduce(
      ...
      (r = o.data.type),
      (o.data.name = X(r)),
      (o.data.displayName = X(r)),
      o.data.type === Canvas && ((o.data.isCanvas = !0), L());
  }
  n && n(o);
  const s = r.craft;
  if (s) {
    if (
      ((o.data.displayName = s.displayName || s.name || o.data.displayName),
      (o.data.props = E(E({}, s.props || s.defaultProps || {}), o.data.props)),
      (o.data.custom = E(E({}, s.custom || {}), o.data.custom)),
      null != s.isCanvas && (o.data.isCanvas = s.isCanvas),
      s.rules &&
      ...
      return (
        (e[n] =
          null == r
            ...
            ? r.map((e) => ('string' == typeof e ? e : K(e, t)))
            : r),
        e
      );
    }, {})),
      n && (o.key = n);
    const d = { ...a.default.createElement(s, { ...o }) };
    return { ...d, name: W(t, d.type) };
  },
  Q = (e, t) => {
...
function Z(n) {
  const r = n && n.options,
    o = () => Z(n);
  return {
    getDropPlaceholder: (t, r, s, d = (e) => n.nodes[e.id].dom) => {
      const a = n.nodes[r],
        i = o().node(a.id).isCanvas() ? a : n.nodes[a.data.parent];
      if (!i) return;
      ...
      return (
        F(n.nodes, t).forEach(({ node: e, exists: t }) => {
          t &&
            o()
              .node(e.id)
    ...
    parseReactElement: (e) => ({
      toNodeTree(r) {
        let s = (function (e, n) {
            ...
            return (
              'string' == typeof r &&
                (r = a.default.createElement(t.Fragment, {}, r)),
              Y({ data: { type: r.type, props: { ...r.props } } }, (e) => {
                n && n(e, r);
              })
            );
          })(e, (e, t) => {
            const o = W(n.options.resolver, e.data.type);
    ...
    parseFreshNode: (t) => ({
      toNode: (r) =>
        Y(t, (t) => {
          ...
          const o = W(n.options.resolver, t.data.type);
          l.default(null !== o, e.ERROR_NOT_IN_RESOLVER),
...
class ne {
  constructor(e, t) {
    f(this, 'store', void 0),
      ...
      window.addEventListener('dragover', te, !1);
  }
  cleanup() {
    window.removeEventListener('scroll', this.onScrollListener, !0),
      window.removeEventListener('dragover', te, !1);
  }
  onScroll(t) {
    const n = t.target,
  ...
  isNearBorders(e, t, n) {
    ...
    return (
      r + ne.BORDER_OFFSET > n ||
      o - ne.BORDER_OFFSET < n ||
      s + ne.BORDER_OFFSET > t ||
      d - ne.BORDER_OFFSET < t
    );
  }
  isDiff(e) {
    return (
  ...
  getChildDimensions(t) {
    ...
    return this.currentTargetId === t.id && n
      ...
      : t.data.nodes.reduce((t, n) => {
          const r = this.store.query.node(n).get().dom;
          return r && t.push(E({ id: n }, e.getDOMInfo(r))), t;
        }, []);
  }
  getCanvasAncestor(e) {
    if (
  ...
  computeIndicator(t, n, r) {
    let o = this.getCanvasAncestor(t);
    if (!o) return;
    if (
    ...
    const s = G(o, this.currentTargetChildDimensions, n, r);
    ...
    return {
      ...
      drag: (t, n) => {
        ...
        const r = this.addCraftEventListener(t, 'dragstart', (t) => {
            ...
            (this.draggedElementShadow = re(t, a, oe.forceSingleDragShadow)),
              (this.dragTarget = { type: 'existing', nodes: s }),
              (this.positioner = new ne(this.options.store, this.dragTarget));
          }),
            ...
            t.craft.stopPropagation(),
              this.dropElement((t, n) => {
                'existing' !== t.type &&
                  ...
                  r && c.default(r.onCreate) && r.onCreate(t.tree));
              });
          });
        return () => {
...
f(oe, 'forceSingleDragShadow', e.isChromium() && e.isLinux());
const se = () => {
    const { indicator: n, indicatorOptions: r, enabled: o } = O((e) => ({
  ...
  le = (t, n) =>
    e.useMethods(ie, { ...ae, options: { ...ae.options, ...t } }, Z, n),
  ce = ['events', 'data'],
  ue = ['nodes'],
  pe = ['nodes'],
  he = ['_hydrationTimestamp', 'rules'],
  fe = ['_hydrationTimestamp', 'rules'],
  ge = (e) => {
    const {
        events: t,
  ...
  Ee = (e) => {
    const t = {},
      n = (e) => {
        const { node: r, childNodes: o, linkedNodes: s } = ge(e);
        (t[r.id] = r),
          o &&
            o.forEach((e, o) => {
              const { node: s, childNodes: d, linkedNodes: a } = ge(e);
              (s.data.parent = r.id),
                (t[s.id] = s),
                (r.data.nodes[o] = s.id),
                n(
          ...
          s &&
            Object.keys(s).forEach((e) => {
              const { node: o, childNodes: d, linkedNodes: a } = ge(s[e]);
...
Object.defineProperty(exports, 'ROOT_NODE', {
  ...
  (exports.ActionMethodsWithConfig = ie),
      ...
      o = le(r.current, (t, n, r, o, s) => {
        ...
        for (let r = 0; r < d.length; r++) {
          ...
          if (
            ...
            s((e) => {
              t.options.normalizeNodes && t.options.normalizeNodes(e, n, a, o);
            });
            break;
          }
        }
  ...
  (exports.Frame = ({ children: n, json: r, data: o }) => {
    ...
    if (!i.current) {
      ...
      if (t) s.history.ignore().deserialize(t);
        ...
        s.history.ignore().addNodeTree(r);
      }
      i.current = !0;
    }
    return a.default.createElement(P, null);
  }),
  (exports.NodeElement = I),
  (exports.NodeHelpers = J),
  (exports.NodeProvider = h),
  (exports.Positioner = ne),
  (exports.QueryMethods = Z),
  (exports.connectEditor = function (e) {
    return (t) => (n) => {
      const r = e ? M(e) : M();
      return a.default.createElement(t, { ...r, ...n });
    };
  }),
  ...
  (exports.createTestState = function () {
    ...
    return E(
      E(E({}, ae), e),
      {},
      { nodes: t ? Ee(t) : {}, events: E(E({}, ae.events), n || {}) }
    );
  }),
  (exports.defaultElementProps = S),
  (exports.deprecateCanvasComponent = L),
  (exports.editorInitialState = ae),
  ...
  (exports.serializeNode = U),
  (exports.useEditor = M),
  (exports.useEditorStore = le),
  (exports.useEventHandler = y),
  (exports.useNode = _);
