...
export declare const ActionMethodsWithConfig: {
  methods: (
    state: EditorState,
    query: import('@craftjs/utils').QueryCallbacksFor<typeof QueryMethods>
  ) => {
    setState(
      cb: (
        state: EditorState,
        actions: import('@craftjs/utils').Delete<
          import('@craftjs/utils').CallbacksFor<
            (
              state: EditorState,
              query: import('@craftjs/utils').QueryCallbacksFor<
                typeof QueryMethods
              >
            ) => {
              ...
              delete(
                selector: import('../interfaces').NodeSelector<
                  import('../interfaces').NodeSelectorType.Id
                >
              ): void;
              deserialize(
                input: import('../interfaces').SerializedNodes | string
              ): void;
              move(
                selector: import('../interfaces').NodeSelector,
                newParentId: NodeId,
              ...
              setNodeEvent(
                ...
                nodeIdSelector: import('../interfaces').NodeSelector<
                  import('../interfaces').NodeSelectorType.Id
                >
              ): void;
              ...
              setIndicator(
                indicator: import('../interfaces').Indicator | null
              ): void;
